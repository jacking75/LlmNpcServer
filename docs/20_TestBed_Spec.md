...
> **이 문서는 "무엇을 왜 이렇게 만드는가"다.** 작업 순서와 완료 조건을 적었던 `20_TestBed_TASKS.md` 는
> 구현 완료로 삭제했다 (2026-08-06) — 원문은 `git log --diff-filter=D -- docs/` 에 있고, 진행 상태는 [`../TASKS.md`](../TASKS.md) §3 에 있다.
>
...
| 6:00 | 12:00 Noon | 시장 존 인구 증가. 상인 계열 활동 |
