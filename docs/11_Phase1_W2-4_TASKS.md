...
[x] T1-41 NullLink          [x] T1-42 LoopbackLink   [x] T1-43 RecordingLink
[x] T1-44 ReplayLink        [x] T1-45 TcpLink골격
[x] T1-46 SimWorld          [x] T1-47 이동시뮬       [x] T1-48 상호작용시뮬
[x] T1-49 Transform발행     [x] T1-50 욕구진행       [x] T1-51 플레이어봇
[x] T1-52 시나리오로더      [x] T1-53 실패·드롭주입

W4 ── 폴백 · 인스턴스 · 호스트 · 튜닝
[x] T1-54 폴백40개 수작성 ★ [x] T1-55 폴백로더       [x] T1-56 NPC5000생성
[x] T1-57 Host CLI+DI       [x] T1-58 메트릭         [x] T1-59 대시보드1차
[x] T1-60 할당제거          [x] T1-61 전환지터       [x] T1-62 게이트검증 ★
```
