...
```
W7 ── 스토어 · 무효화
[x] T3-01 PlanStore배열     [x] T3-02 pinned보호      [x] T3-03 개별플랜풀
[x] T3-04 캐시메트릭        [x] T3-05 Manifest모델    [x] T3-06 무효화판정 ★
[x] T3-07 파일저장/로드

W8 ── 프리베이크 · 검수
[x] T3-08 CLI골격           [x] T3-09 대상버킷산출    [x] T3-10 우선순위정렬
[x] T3-11 프리픽스워밍업 ★  [x] T3-12 AIMD           [x] T3-13 429백오프
[x] T3-14 예산하드캡        [x] T3-15 전수드라이런    [x] T3-16 manifest작성
[x] T3-17 검수도구 ★        [ ] T3-18 검수기록        [x] T3-19 pinned승격
[x] T3-20 Host결선          [~] T3-21 게이트검증 ★
```

**T3-18 은 사람이 한다.** `tools/review.ps1` 은 완성됐고(T3-17), 남은 것은 40건을 실제로 검수하는 일이다.
`T3-21` 은 기제 항목(5·6·7·8)이 통과했고 실측 산출물이 필요한 항목(1~4·9)이 남았다 —
판정 현황은 [`measurements/P3_gate.md`](measurements/P3_gate.md) 에 있다.
